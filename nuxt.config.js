export default {
  ...
  head: {
    title: 'Französische bulldogge welpen',
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { hid: 'description', name: 'description', content: 'Eine Website über französische Bulldoggen.' }
    ],
    link: [
    ...
    extendRoutes(routes, resolve) {
      routes.push(
        ...
        },
        {
          ...
          path: '/welpen/verfuegbare-welpen',
          component: 'pages/puppies.vue',
        },
        {
          name: 'puppies-with-parents',
          path: '/welpen/welpen-mit-eltern',
          component: 'pages/puppies.vue',
        },
        {
          name: 'breedDE',
          path: '/rasseninfo/franzoesische-bulldogge',
